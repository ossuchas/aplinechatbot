...
class ExecutiveReportModel(db.Model):
    ...
    sub_period = db.Column(db.Integer)
    ...
    bg1_up_grosspresalesunit = db.Column(db.Float)
    bg1_up_grosspresalesamount = db.Column(db.Float)
    bg2_up_grosspresalesunit = db.Column(db.Float)
    bg2_up_grosspresalesamount = db.Column(db.Float)
    bg3_up_grosspresalesunit = db.Column(db.Float)
    bg3_up_grosspresalesamount = db.Column(db.Float)
    bg4_up_grosspresalesunit = db.Column(db.Float)
    bg4_up_grosspresalesamount = db.Column(db.Float)
    # Modified by Sucaht s. 2020-10-27
    bg1_up_cancelunit = db.Column(db.Float)
    bg1_up_cancelamount = db.Column(db.Float)
    bg2_up_cancelunit = db.Column(db.Float)
    bg2_up_cancelamount = db.Column(db.Float)
    bg3_up_cancelunit = db.Column(db.Float)
    bg3_up_cancelamount = db.Column(db.Float)
    bg4_up_cancelunit = db.Column(db.Float)
    bg4_up_cancelamount = db.Column(db.Float)
    bg1_up_netpresalesunit = db.Column(db.Float)
    bg1_up_netpresalesamount = db.Column(db.Float)
    bg2_up_netpresalesunit = db.Column(db.Float)
    bg2_up_netpresalesamount = db.Column(db.Float)
    bg3_up_netpresalesunit = db.Column(db.Float)
    bg3_up_netpresalesamount = db.Column(db.Float)
    bg4_up_netpresalesunit = db.Column(db.Float)
    bg4_up_netpresalesamount = db.Column(db.Float)
    bg1_up_transferunit = db.Column(db.Float)
    bg1_up_transferamount = db.Column(db.Float)
    bg2_up_transferunit = db.Column(db.Float)
    bg2_up_transferamount = db.Column(db.Float)
    bg3_up_transferunit = db.Column(db.Float)
    bg3_up_transferamount = db.Column(db.Float)
    bg4_up_transferunit = db.Column(db.Float)
    bg4_up_transferamount = db.Column(db.Float)
    ...
    def find_by_period(cls, _period) -> "ExecutiveReportModel":
        return cls.query.filter_by(period=_period, sub_period=0).first()
    ...
    @classmethod
    def find_Year2DateQ3(cls) -> "ExecutiveReportModel":
        return cls.query.filter_by(trans_id=7, period='YTD').first()
