...
def replyMsg(Reply_token: str = None, ex: ExecutiveReportModel = None,
             last_ex: ExecutiveReportModel = None, line_Acees_Token: str = None):
    ...
    current_week = {
        ...
        "body": {
            ...
            "contents": [
                ...
                # Modified by Suchat S. 2020-10-28 for add BG Up-Country
                {
                    "type": "box",
                    "layout": "baseline",
                    "contents": [
        ...
        "footer": {
            ...
            "layout": "vertical",
            "contents": [
                { "type": "text", "text": "Copyright 2019 AP (Thailand) PCL.", "size": "xxs", "align": "center", "color": "#ffffff" },
                { "type": "box", "layout": "vertical", "contents": [ { "type": "image", "url": "https://i.ibb.co/fS0B4wP/AP-Logo-2018.png" } ],
                    "position": "absolute", "width": "32px", "height": "32px", "offsetBottom": "2px" }
            ]
        },
        "styles": { "header": { "backgroundColor": "#000000" }, "hero": { "backgroundColor": "#000000" }, "footer": { "backgroundColor": "#000000" } }
    }
    ...
    last_week = {
        ...
        "header": {
            ...
            "contents": [
                {"type": "text", "text": "Ex.", "size": "lg", "color": "#FFFFFF"},
                {
                    ...
                    "layout": "vertical",
                    "contents": [
                        {"type": "text", "text": last_ex.text_msg_header, "color": "#FFFFFF", "align": "end",
                         "gravity": "bottom", "size": "sm", "flex": 1},
                        {"type": "text", "text": last_ex.text_msg_detail, "align": "end", "color": "#FFFFFF",
                         "size": "xxs", "flex": 0, "style": "italic"}
                    ],
                    "flex": 0,
                    "height": "32px"
                }
        ...
        "body": {
            ...
            "contents": [
                ...
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_grosspresalesamount:,.2f}", "size": "xs",
                         "align": "end"}
                    ]
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_up_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_up_grosspresalesamount:,.2f}", "size": "xs",
                         "align": "end"}
                    ]
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "TH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_grosspresalesamount:,.2f}", "size": "xs",
                         "align": "end"}
                    ]
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "TH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_up_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_up_grosspresalesamount:,.2f}", "size": "xs",
                         "align": "end"}
                    ]
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "CD1", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg3_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg3_grosspresalesamount:,.2f}", "size": "xs",
                         "align": "end"}
                    ]
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "CD2", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg4_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg4_grosspresalesamount:,.2f}", "size": "xs",
                         "align": "end"}
                    ]
                },
                # {
                ...
                #     "contents": [
                #         {"type": "text", "text": "CD2", "size": "xs", "align": "start", "offsetStart": "50px"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_grosspresalesunit:,.0f}", "size": "xs", "align": "end"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_grosspresalesamount:,.2f}", "size": "xs",
                #          "align": "end"}
                #     ]
                # },
                {
                ...
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "Total", "size": "sm", "align": "end", "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_grosspresalesunit:,.0f}", "size": "sm",
                         "align": "end", "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_grosspresalesamount:,.2f}", "size": "sm",
                         "align": "end", "weight": "bold"}
                    ],
                    "backgroundColor": "#7AFF97"
                },
                ...
                },
                {
                    ...
                    "layout": "baseline",
                    "contents": [
                        {"type": "text", "text": ":: Cancel ::", "size": "md", "weight": "bold", "align": "center",
                         "color": "#FFFFFF"}
                    ],
                    "margin": "md",
                    "backgroundColor": "#23ACE8"
                ...
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_cancelunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_cancelamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_up_cancelunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_up_cancelamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "TH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_cancelunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_cancelamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "TH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_up_cancelunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_up_cancelamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "CD1", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg3_cancelunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg3_cancelamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "CD2", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg4_cancelunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg4_cancelamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                # {
                #     "type": "box",
                ...
                #     "contents": [
                #         {"type": "text", "text": "CD2 Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_cancelunit:,.0f}", "size": "xs", "align": "end"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_cancelamount:,.2f}", "size": "xs", "align": "end"}
                #     ]
                # },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "Total", "size": "sm", "align": "end", "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_cancelunit:,.0f}", "size": "sm", "align": "end",
                         "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_cancelamount:,.2f}", "size": "sm", "align": "end",
                         "weight": "bold"}
                    ],
                    "backgroundColor": "#7AFF97"
                },
                ...
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_up_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_up_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "TH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "TH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_up_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_up_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "CD1", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg3_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg3_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "CD2", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg4_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg4_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                # {
                #     "type": "box",
                ...
                #     "contents": [
                #         {"type": "text", "text": "CD2 Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_netpresalesunit:,.0f}", "size": "xs", "align": "end"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_netpresalesamount:,.2f}", "size": "xs", "align": "end"}
                #     ]
                # },
                {
                    "type": "separator"
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "Total", "size": "sm", "align": "end", "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_netpresalesunit:,.0f}", "size": "sm", "align": "end",
                         "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_netpresalesamount:,.2f}", "size": "sm",
                         "align": "end", "weight": "bold"}
                    ],
                    "backgroundColor": "#7AFF97"
                },
                ...
                },
                {
                    ...
                    "layout": "baseline",
                    "contents": [
                        {"type": "text", "text": ":: Transfer ::", "size": "md", "weight": "bold", "align": "center",
                         "color": "#FFFFFF"}
                    ],
                    "margin": "md",
                    "backgroundColor": "#23ACE8"
                ...
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_transferunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_transferamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "SDH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg1_up_transferunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg1_up_transferamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "TH", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_transferunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_transferamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "TH Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg2_up_transferunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg2_up_transferamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "CD1", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg3_transferunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg3_transferamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                {
                    "type": "box",
                    ...
                    "contents": [
                        {"type": "text", "text": "CD2", "size": "xs", "align": "start", "offsetStart": "50px"},
                        {"type": "text", "text": f"{last_ex.bg4_transferunit:,.0f}", "size": "xs", "align": "end"},
                        {"type": "text", "text": f"{last_ex.bg4_transferamount:,.2f}", "size": "xs", "align": "end"}
                    ]
                },
                # {
                #     "type": "box",
                ...
                #     "contents": [
                #         {"type": "text", "text": "CD2 Up-C", "size": "xs", "align": "start", "offsetStart": "50px"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_transferunit:,.0f}", "size": "xs", "align": "end"},
                #         {"type": "text", "text": f"{last_ex.bg4_up_transferamount:,.2f}", "size": "xs", "align": "end"}
                #     ]
                # },
                {
                    "type": "separator"
                },
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "Total", "size": "sm", "align": "end", "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_transferunit:,.0f}", "size": "sm", "align": "end",
                         "weight": "bold"},
                        {"type": "text", "text": f"{last_ex.total_transferamount:,.2f}", "size": "sm", "align": "end",
                         "weight": "bold"}
                    ],
                    "backgroundColor": "#7AFF97"
                },
        ...
        "footer": {
            ...
            "layout": "vertical",
            "contents": [
                {"type": "text", "text": "Copyright 2019 AP (Thailand) PCL.", "size": "xxs", "align": "center",
                 "color": "#ffffff"},
                {"type": "box", "layout": "vertical",
                 "contents": [{"type": "image", "url": "https://i.ibb.co/fS0B4wP/AP-Logo-2018.png"}],
                 "position": "absolute", "width": "32px", "height": "32px", "offsetBottom": "2px"}
            ]
        },
        "styles": {"header": {"backgroundColor": "#000000"}, "hero": {"backgroundColor": "#000000"},
    ...
    # data = {"replyToken": Reply_token, "messages": [type_msg]}
